...
import { signup, signin, me, updateProfile, setup2FA, verify2FA, disable2FA, login2FA, deleteAccount, updateWatermark } from "../controllers/auth.controller.js";
...
router.put("/watermark", authenticate, asyncHandler(updateWatermark));

router.post("/delete-account", authenticate, asyncHandler(deleteAccount));
