    ...
    >
      <View style={styles.centerDevice}>
        <View style={styles.deviceScreen}>
          <Ionicons name="grid" size={24} color={getColors().terracotta} />
      ...
      <GlowDot size={6} color={getColors().terracotta} style={{ position: "absolute", top: 5, left: width * 0.25 }} delay={200} />
      ...
      <GlowDot size={4} color={getColors().terracottaShadow} style={{ position: "absolute", bottom: 70, right: width * 0.28 }} delay={400} />
    </Animated.View>
  );
}
...
function ConnectScene() {
  ...
  const platforms = [
    ...
    { icon: "logo-youtube", color: getColors().terracotta, angle: 180 },
    ...
    >
      <View style={styles.hubCenter}>
        <View style={styles.hubInner}>
          <Ionicons name="link" size={28} color={getColors().terracotta} />
        </View>
      </View>
      ...
      <GlowDot size={8} color={getColors().terracotta} style={{ position: "absolute", top: 0, left: width * 0.2 }} delay={100} />
      ...
      <GlowDot size={4} color={getColors().terracottaShadow} style={{ position: "absolute", bottom: 30, right: width * 0.15 }} delay={400} />
    </Animated.View>
  );
}
    ...
    >
      ...
      >
        <View style={styles.rocketBody}>
          <Ionicons name="rocket" size={44} color={getColors().terracotta} />
        </View>
      </Animated.View>
      ...
      <GlowDot size={6} color={getColors().terracotta} style={{ position: "absolute", top: 5, right: width * 0.25 }} delay={200} />
      <GlowDot size={5} color={getColors().terracottaShadow} style={{ position: "absolute", bottom: 60, right: width * 0.2 }} delay={500} />
        ...
        <View style={styles.content}>
          <View style={styles.header}>
            <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
              <View style={{ width: 32, height: 32, borderRadius: 8, backgroundColor: getColors().terracotta, alignItems: "center", justifyContent: "center" }}>
                <Ionicons name="share-social" size={16} color={getColors().paperLight} />
              </View>
            ...
            <TouchableOpacity onPress={onComplete} style={styles.skipButton}>
              ...
              <Ionicons name="arrow-forward" size={14} color={getColors().inkMuted} />
            </TouchableOpacity>
          </View>
          ...
          {isLastSlide ? (
            <TouchableOpacity onPress={onComplete} style={styles.getStartedButton}>
              ...
              <View style={styles.getStartedIcon}>
                <Ionicons name="arrow-forward" size={20} color={getColors().paperLight} />
              </View>
            </TouchableOpacity>
          ) : (
            <View style={styles.navigationButtons}>
              ...
              >
                <Ionicons name="arrow-back" size={16} color={getColors().inkMuted} />
                <Text style={styles.backText}>Back</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={goToNext} style={styles.continueButton}>
                <Text style={styles.continueText}>Continue</Text>
                <Ionicons name="arrow-forward" size={16} color={getColors().paperLight} />
              </TouchableOpacity>
            </View>
          )}
        </View>
...
const styles = StyleSheet.create({
  ...
  stepDot: {
    ...
    height: 6,
    borderRadius: 3,
    backgroundColor: getColors().terracotta,
    marginRight: 8,
  },
  stepText: {
    color: getColors().terracotta,
  ...
  centerDevice: {
    ...
    alignItems: "center",
    justifyContent: "center",
    shadowColor: getColors().terracotta,
  ...
  dotInactive: {
    width: 8,
    height: 8,
    backgroundColor: getColors().paperDeep,
  },
