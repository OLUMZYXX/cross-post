          ...
          <View className="flex-1 px-6 pt-16 pb-10">
              ...
              <View className="bg-gray-900/80 rounded-3xl p-6 border border-gray-800">
                <View className="mb-5">
                  ...
                  <View className="bg-gray-800 rounded-xl border border-gray-700 px-4 py-4">
                    <TextInput value={name} onChangeText={setName} placeholder="Enter your full name" placeholderTextColor="#6b7280" className="text-white text-base" editable={!loading} />
                  </View>
                </View>
                <View className="mb-5">
                  <Text className="text-gray-400 text-sm mb-2 font-medium">Email Address</Text>
                  <View className="bg-gray-800 rounded-xl border border-gray-700 px-4 py-4">
                    <TextInput value={email} onChangeText={setEmail} placeholder="Enter your email" placeholderTextColor="#6b7280" keyboardType="email-address" autoCapitalize="none" className="text-white text-base" editable={!loading} />
                  </View>
                </View>
                <View className="mb-5">
                  ...
                  <View className="bg-gray-800 rounded-xl border border-gray-700 px-4 py-4 flex-row items-center">
                    <TextInput value={password} onChangeText={setPassword} placeholder="Create a password" placeholderTextColor="#6b7280" secureTextEntry={!showPassword} className="text-white text-base flex-1" editable={!loading} />
                ...
                <View className="mb-6">
                  ...
                  <View className="bg-gray-800 rounded-xl border border-gray-700 px-4 py-4 flex-row items-center">
                    <TextInput value={confirmPassword} onChangeText={setConfirmPassword} placeholder="Confirm your password" placeholderTextColor="#6b7280" secureTextEntry={!showConfirmPassword} className="text-white text-base flex-1" editable={!loading} />
                    <TouchableOpacity onPress={() => setShowConfirmPassword(!showConfirmPassword)} className="ml-2">
                      <Ionicons name={showConfirmPassword ? "eye-off" : "eye"} size={20} color="#6b7280" />
                    </TouchableOpacity>
                  </View>
                </View>
                <TouchableOpacity onPress={handleSignUp} disabled={loading} className={`py-4 rounded-xl border border-green-400 mb-4 ${loading ? "bg-green-500/50" : "bg-green-500"}`}>
                  {loading ? <ActivityIndicator color="#030712" /> : <Text className="text-gray-950 text-center text-lg font-bold">Create Account</Text>}
                </TouchableOpacity>
                ...
                {Platform.OS === "ios" && (
                  <TouchableOpacity onPress={handleAppleSignUp} disabled={loading} className="bg-gray-800 py-4 rounded-xl border border-gray-700 flex-row items-center justify-center">
                    <Ionicons name="logo-apple" size={20} color="#fff" style={{ marginRight: 12 }} />
            ...
            <View className="flex-row justify-center mt-6">
              ...
              <TouchableOpacity onPress={onNavigateToSignIn} disabled={loading}>
                <Text className="text-green-400 text-base font-semibold">Login</Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
